...
export default function RecipieSearch(props) {
    const {handleRecipieDelete , handleRecipieSelect} = props.recipieContextValue
    const {name,
        servings,
        id,
        cookTime,
  ...
  return (
    <div  className='removeme searchRecipie recipie'>
